...
public class CrossKStartController {
    ...
    @ApiOperation(value = "测试-发起方调用方法", httpMethod = "POST", notes = "提供crossk接收计算")
    public String startCompareTask(
            ...
            @ApiParam(required = false, name = "dis", value = "distance") @RequestParam(name = "dis", required = false) int dis)
        ...
        return localmoranservice.startCompareTask(id, input, type, roomId, user1, user2);
    }
    ...
    public String queryResult(
            ...
            throws Exception {
        return localmoranservice.query(id);
    }
